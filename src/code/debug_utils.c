...
void Debug_DrawProfiler(s32 x, s32 y) {
    ...
    gDPSetFillColor(gMasterDisplayList++, GPACK_RGBA5551(255, 255, 255, 1) | GPACK_RGBA5551(255, 255, 255, 1)
                                                                                 << 16); // white
    ...
    gDPPipeSync(gMasterDisplayList++);
    gDPSetFillColor(gMasterDisplayList++, GPACK_RGBA5551(255, 0, 255, 1) | GPACK_RGBA5551(255, 0, 255, 1)
                                                                               << 16); // magenta
    gDPFillRectangle(gMasterDisplayList++, x + 1, y + 5, x + (D_8016E254 / 10000U) + 1, y + 6);
    gDPPipeSync(gMasterDisplayList++);
    gDPSetFillColor(gMasterDisplayList++, GPACK_RGBA5551(255, 255, 0, 1) | GPACK_RGBA5551(255, 255, 0, 1)
                                                                               << 16); // yellow
    gDPFillRectangle(gMasterDisplayList++, x + (D_8016E254 / 10000) + 1, y + 5,
                     x + (D_8016E254 / 10000) + (D_8016E264 / 10000) + 1, y + 6);
    gDPPipeSync(gMasterDisplayList++);
    gDPSetFillColor(gMasterDisplayList++, GPACK_RGBA5551(255, 255, 255, 1) | GPACK_RGBA5551(255, 255, 255, 1)
                                                                                 << 16); // white
...
void func_8005F488(s16 arg0, s16 arg1, s16 arg2) {
    D_80103928[15] = ((arg0 << 11) + (arg1 << 6) + (arg2 << 1) + 1);
}

void Debug_PrintChar(s16 c, s16 x, s16 y, f32 unused1, f32 unused2) {
    u32 uls;
    u32 ult;
    s32 i;
    ...
    gSPTextureRectangle(gMasterDisplayList++, (x * 4), (y * 4), ((x * 4) + 0x20),
...
void Debug_PrintXY(int x, int y) {
    s32 i;
    ...
    for (i = 0; i < 200; i++) {
        ...
        Debug_PrintChar(c, x, y, 1.0f, 1.0f);
        x += 8;
    }
}
...
UNUSED void func_8005FAA0(u8* arg0, u8* arg1) {
}

UNUSED void func_8005FAB8(int arg0, int arg1) {
