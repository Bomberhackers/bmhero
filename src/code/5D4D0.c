...
void func_8006B1B4(void) {
    ...
    if(D_80177939 == 0)
    {
        if(gPlayerObjectPointer->Pos.x >= 3600.0f)
        {
            D_80177939 = 1; 
        }
        ...
        if(D_80177936 == 0)
        {
            sp04 = (s32) (3000.0f - gPlayerObjectPointer->Pos.x);
            if(sp04 < 0)
            {
                sp04 = 0;
            }            
...
void func_8006B3BC(void) {
    ...
    if(gPlayerObjectPointer->Pos.y < 480.0f)
    {
        if (D_8017793C == 0)
        {
            D_8017793C = func_80014E80(0xA) + 15;
            if(gPlayerObjectPointer->Vel.x == 0.0f && gPlayerObjectPointer->Vel.z == 0.0f)
            {
                sp30 = (f32)func_80014E80(-480) + gPlayerObjectPointer->Pos.x;
            }
            else
            {
                sp30 = (f32)func_80014E80(-960) + gPlayerObjectPointer->Pos.x;
            }

            sp2C = gPlayerObjectPointer->Pos.y + 540.0f;
            sp28 = (f32)func_80014E80(-240) + gPlayerObjectPointer->Pos.z;
