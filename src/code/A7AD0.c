...
void func_800B62C8(void) {
    ...
    if ((s32) sp44->unk132 >= 2) {
        if (func_80028FA0(gCurrentParsedObject) != 0) {
            func_80029B60(gCurrentParsedObject);
            if ((gObjects[sp44->unk104].Pos.y + 60.0f) >= sp44->Pos.y) {
                sp44->unkA8 = 7;
                sp44->unk132 = 3;
                sp44->unk44 = 4.0f;
                sp44->unk40 = 90.0f;
...
void func_800B725C(void) {
    ...
    sp1C = (s32) gObjects[gCurrentParsedObject].unkA4;
    switch (sp1C) {
        case 1:
            func_800B5814();
            break;
...
void func_800B99A4(void) {
    ...
    if (func_80028FA0(gCurrentParsedObject) != 0) {
        if (sp34->unkAE == 0) {
            sp34->Vel.x = 0.0f;
            sp34->Vel.z = 0.0f;
            if ((gObjects[sp34->unk104].Pos.z) < sp34->Pos.z) {
                func_80029C40(gCurrentParsedObject);
            }
        }
