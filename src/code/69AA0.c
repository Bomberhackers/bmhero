    ...
    if (sp93 == 0) {
        if ((sp80 < 60.0f) && (sp70 < 60.0f)) {
            ...
            if (((sp80 != 0.0f) || (sp70 != 0.0f)) &&
                ((func_80016714(D_80177968, D_80177970, D_80177978, D_80177980, spA8, spA4, spA0, sp9C, &sp64, &sp60,
                                &sp5C, &sp58),
                  (sp64 != 0.0f)) ||
...
s32 func_80078AEC(s32 arg0) {
    ...
    sp48 += sp3C;
    sp40 += sp34;
    sp30 = sinf((f32) ((f64) sp4C->moveAngle * DEG_TO_RAD)) * 15.0f;
    sp2C = cosf((f32) ((f64) sp4C->moveAngle * DEG_TO_RAD)) * 15.0f;
...
void func_800797FC(s32 arg0) {
    ...
    spC = &gObjects[arg0];
    spC->Scale.x = spC->Scale.y = spC->Scale.z = spC->unkA8 / 100.0f;
}
...
void func_80079874(s32 arg0) {
    ...
    sp1C = &gObjects[arg0];
    sp1C->Pos.x = (sinf((f32) ((f64) gPlayerObject->Rot.y * DEG_TO_RAD)) * 32.0f) + gPlayerObject->Pos.x;
    sp1C->Pos.z = (cosf((f32) ((f64) gPlayerObject->Rot.y * DEG_TO_RAD)) * 32.0f) + gPlayerObject->Pos.z;
}
...
void func_800799A8(s32 arg0) {
    ...
    sp24 = &gObjects[arg0];
    sp24->Vel.x =
        (sp24->moveSpeed * cosf((f32) ((f64) sp24->unk40 * DEG_TO_RAD))) * sinf((f32) ((f64) sp24->moveAngle * DEG_TO_RAD));
    sp24->Vel.z =
        (sp24->moveSpeed * cosf((f32) ((f64) sp24->unk40 * DEG_TO_RAD))) * cosf((f32) ((f64) sp24->moveAngle * DEG_TO_RAD));
}
...
void func_80079AD8(s32 arg0) {
    ...
    sp1C = &gObjects[arg0];
    sp1C->Vel.y = sinf((f32) ((f64) sp1C->unk40 * DEG_TO_RAD)) * sp1C->moveSpeed;
}
...
void func_80079BEC(f32* arg0, s32 arg1, s16* arg2, f32 arg3) {
    ...
    guMtxXFMF(sp28, arg2[(arg1 * 3)], arg2[(arg1 * 3) + 1] + arg3, arg2[arg1 * 3 + 2], arg0, arg0 + 1, arg0 + 2);
}
...
void func_8007A024(void) {
    ...
    if (sp1C != -1) {
        ...
        sp18->moveAngle = gPlayerObject->Rot.y;
        gObjIdx = (s16) sp1C;
    } else {
        gObjIdx = 0;
    }
...
void func_8007A120(void) {
    ...
    sp4->unkB4 = (s16) (s32) gPlayerObject->moveSpeed;
    gObjIdx = 0;
}
...
void func_8007A3A0(s32 arg0) {
    ...
    if (sp1C->actionState != 0) {
        ...
        sp1C->unkD4 = gPlayerObject->Pos.y;
        sp1C->unkB6 = 0;
        sp1C->moveSpeed = 30.0f;
        sp1C->moveAngle = gPlayerObject->Rot.y;
        sp1C->unk40 = 0.0f;
        func_800799A8(arg0);
        func_80079AD8(arg0);
    }
...
void func_8007A488(s32 arg0) {
    ...
    if (sp1C != -1) {
        ...
        sp18->moveAngle = Math_WrapAngle(gPlayerObject->Rot.y, D_8010C7E4[arg0].z);
        sp18->moveSpeed = D_8010C7E4[arg0].x;
        func_800799A8(sp1C);
        func_80079AD8(sp1C);
    }
}
...
void func_8007A938(s32 arg0) {
    ...
    sp1C = &gObjects[arg0];
    sp1C->Pos.x = (sinf((gPlayerObject->Rot.y * DEG_TO_RAD)) * 32.0f) + gPlayerObject->Pos.x;
    sp1C->Pos.z = (cosf((gPlayerObject->Rot.y * DEG_TO_RAD)) * 32.0f) + gPlayerObject->Pos.z;
...
void func_8007AD60(s32 arg0) {
    ...
    if (sp18 == 4) {
        if (sp1C->actionState == 0x24) {
            ...
            sp1C->moveAngle = gPlayerObject->Rot.y;
            if (D_80165268 == 0) {
                sp1C->moveSpeed = ((f32) sp1C->unkB4 / 3.0f) + 28.0f + (f32) gFireCount;
            } else {
                sp1C->moveSpeed = ((f32) sp1C->unkB4 / 3.0f) + 60.0f + (f32) gFireCount;
            }
            func_800799A8(arg0);
            func_80079AD8(arg0);
        } else {
...
void func_8007B004(s32 arg0) {
    ...
    if (sp98 == 6) {
        ...
        sp9C->moveSpeed = 0.0f;
        sp9C->moveAngle = gPlayerObject->Rot.y;
        sp9C->unk40 = 0.0f;
        func_800799A8(arg0);
        func_80079AD8(arg0);
        sp9C->damageState = 1;
...
void func_8007BBD8(s32 arg0, f32 arg1, f32 arg2, f32 arg3) {
    ...
    sp1C->moveAngle = Math_WrapAngle(sp1C->moveAngle, arg1);
    func_800799A8(arg0);
    if (arg2 != 0.0f) {
...
void func_8007BF18(void) {
    ...
    sp24->moveAngle = gPlayerObject->Rot.y;
...
void func_8007C06C(s32 arg0, f32 arg1, f32 arg2, f32 arg3) {
    ...
    if (sp1C != -1) {
        ...
        sp18->Pos.z = arg3;
        sp18->unk40 = 0.0f;
        sp18->moveAngle = Math_WrapAngle(gPlayerObject->Rot.y, D_8010C8FC[arg0]);
        sp18->moveSpeed = 24.0f;
        func_800799A8(sp1C);
        func_80079AD8(sp1C);
    }
}
...
void func_8007C8A0(s32 arg0) {
    ...
    if (sp34 != 64) {
        ...
        sp64 = func_800157EC(sp6C->moveAngle, sp68, 2.0f);
        sp6C->moveAngle = Math_WrapAngle(sp6C->moveAngle, (f32) sp64);
    ...
    sp6C->Rot.y = Math_WrapAngle(sp6C->moveAngle, -180.0f);
    ...
    if (sp6C->unkB2 == 0) {
        func_80081468(0x2C5, sp6C->Pos.x - (sinf((f32) ((f64) sp6C->moveAngle * DEG_TO_RAD)) * 20.0f), sp6C->Pos.y,
                      sp6C->Pos.z - (cosf((f32) ((f64) sp6C->moveAngle * DEG_TO_RAD)) * 20.0f));
        sp6C->unkB2 = 1;
    } else {
        sp6C->unkB2 -= 1;
    }
...
void func_8007CF98(s32 arg0, f32 arg1, f32 arg2, f32 arg3) {
    ...
    if (sp1C != -1) {
        ...
        sp18->Pos.z = arg3;
        sp18->unk40 = 0.0f;
        sp18->moveAngle = Math_WrapAngle(gPlayerObject->Rot.y, D_8010C924[arg0]);
        sp18->moveSpeed = 40.0f;
        func_800799A8(sp1C);
        func_80079AD8(sp1C);
    }
}
...
void func_8007D768(s32 arg0) {
    ...
    if (sp34->unkB2 == 0) {
        func_80081468(0x2C5, sp34->Pos.x - (sinf((f32) ((f64) sp34->moveAngle * DEG_TO_RAD)) * 20.0f), sp34->Pos.y,
                      sp34->Pos.z - (cosf((f32) ((f64) sp34->moveAngle * DEG_TO_RAD)) * 20.0f));
        sp34->unkB2 = 1;
    } else {
        sp34->unkB2 -= 1;
    }
...
void func_8007DC0C(s32 arg0, f32 arg1, f32 arg2, f32 arg3) {
    ...
    if (sp1C != -1) {
        ...
        sp18->moveAngle = Math_WrapAngle(gPlayerObject->Rot.y, D_8010C94C[arg0].x);
        sp18->moveSpeed = 14.0f;
        func_800799A8(sp1C);
        func_80079AD8(sp1C);
    }
}
