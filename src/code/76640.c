    ...
    if (sp93 == 0) {
        if ((sp80 < 60.0f) && (sp70 < 60.0f)) {
            ...
            if (((sp80 != 0.0f) || (sp70 != 0.0f)) &&
                ((func_80016714(D_801651AC, D_801651B0, D_801651B4, D_801651B8, spA8, spA4, spA0, sp9C, &sp64, &sp60,
                                &sp5C, &sp58),
                  (sp64 != 0.0f)) ||
...
void func_80084BD8(f32* arg0, s32 arg1, f32 arg2, f32 arg3) {
    ...
    if (arg1 == 1) {
        ...
        for (sp30 = 0; sp30 < 0x1E; sp30++) {
            ...
            for (sp28 = 0; sp28 < 8; sp28++) {
                sp24 = func_80084430(arg0[sp28 * 3 + 0] + player_pos_x, arg0[sp28 * 3 + 1] + player_pos_y,
                                     arg0[sp28 * 3 + 2] + player_pos_z);
                if (sp24 == 4) {
    ...
    if ((D_8016523E == 0) || (D_8016523E == 5) || (D_8016523E == 6)) {
        ...
        if (D_80165270 != -1) {
            if (D_80177760[D_801776E0 & 1] == player_pos_y) {
                D_80165280 = gObjects[D_80165270].objID;
...
void func_80085884(void) {
    ...
    if (D_8016E238 == 0) {
        if (D_80165270 != -1) {
            if ((gObjects[D_80165270].actionState == 0) || (gObjects[D_80165270].objID != D_80165280)) {
                sp1C = -1;
            } else {
                sp1C = (s32) D_80165270;
            }
        } else {
            if ((gObjects[D_8016E2A8].actionState == 0) || (gObjects[D_8016E2A8].objID != D_8016E2B8)) {
                sp1C = -1;
            } else {
                sp1C = (s32) D_8016E2A8;
            }
        ...
        sp18 = D_8016E240 - 2;
        if (D_801779B0[sp18] != -1) {
            if ((gObjects[D_801779B0[sp18]].actionState == 0) || gObjects[D_801779B0[sp18]].objID != D_801779C0[sp18]) {
                sp1C = -1;
            } else {
                sp1C = D_801779B0[sp18];
            }
...
void func_80086ECC(void) {
    ...
    if (gPlayerArmWindObject->actionState == 0) {
        return;
    }

    if (gPlayerArmWindObject->objID == 0x2A8) {
        ...
        } else if (gPlayerArmWindObject->actionState == 2) {
            gPlayerArmWindObject->Pos.x = gPlayerObject->Pos.x;
            gPlayerArmWindObject->Pos.y = gPlayerObject->Pos.y;
            gPlayerArmWindObject->Pos.z = gPlayerObject->Pos.z;
            gPlayerArmWindObject->Rot.y = gPlayerObject->Rot.y;
        }
    } else if (gPlayerArmWindObject->objID == 0x2A9) {
        if (gPlayerArmWindObject->actionState == 1) {
            gPlayerArmWindObject->Pos.x = gPlayerObject->Pos.x;
            gPlayerArmWindObject->Pos.y = gPlayerObject->Pos.y;
            gPlayerArmWindObject->Pos.z = gPlayerObject->Pos.z;
    ...
    } else if (gPlayerArmWindObject->objID == 0x2AE) {
        if (gPlayerArmWindObject->actionState == 1) {
            gPlayerArmWindObject->Pos.x = gPlayerObject->Pos.x;
    ...
    } else if (gPlayerArmWindObject->objID == 0x2AA) {
        if (gPlayerArmWindObject->actionState == 1) {
            gPlayerArmWindObject->Pos.x = gPlayerObject->Pos.x;
            gPlayerArmWindObject->Pos.y = gPlayerObject->Pos.y;
            gPlayerArmWindObject->Pos.z = gPlayerObject->Pos.z;
    ...
    } else if (gPlayerArmWindObject->objID == 0x2AB) {
        if (gPlayerArmWindObject->actionState == 1) {
        ...
        if (gPlayerArmWindObject->actionState == 1) {
            if (gPlayerObject->actionState == 0x26D) {
    ...
    } else if ((gPlayerArmWindObject->objID == 0x2AD)) {
        if (gPlayerArmWindObject->actionState == 1) {
            gPlayerArmWindObject->Pos.x = gPlayerObject->Pos.x;
            gPlayerArmWindObject->Pos.y = gPlayerObject->Pos.y;
            gPlayerArmWindObject->Pos.z = gPlayerObject->Pos.z;
...
void func_80087994(void) {
    ...
    if (D_8016523E == 0) {
        func_8028AA70_code_extra_0();
    } else if (D_8016523E == 1) {
        func_802838DC_code_extra_1();
    } else if (D_8016523E == 2) {
        func_802823A4_code_extra_2();
    } else if (D_8016523E == 3) {
        func_80281314_code_extra_3();
    } else if (D_8016523E == 4) {
        func_8028117C_code_extra_4();
    } else if (D_8016523E == 5) {
        func_802860F8_code_extra_5();
    } else if (D_8016523E == 6) {
        func_80282F24_code_extra_6();
    }
    func_80086D50();
    func_80086ECC();
}
...
void func_80087B1C(void) {
    ...
    func_8001BB34(1, 0);
    if (D_8016523E == 0) {
        func_8028ADB0_code_extra_0();
    } else if (D_8016523E == 1) {
        func_80283A40_code_extra_1();
    } else if (D_8016523E == 2) {
        func_802824DC_code_extra_2();
    } else if (D_8016523E == 3) {
        func_802813E4_code_extra_3();
    } else if (D_8016523E == 4) {
        func_802812AC_code_extra_4();
    } else if (D_8016523E == 5) {
        func_80286374_code_extra_5();
    } else if (D_8016523E == 6) {
        func_802831BC_code_extra_6();
    }
    func_80086D50();
    func_80086ECC();
}
...
void func_80087C58(void) {
    ...
    if ((gPlayerArmWindObject->actionState != 0) && (func_8001C1A8(1, 0) != 0)) {
        func_8001838C();
        func_8001B014(1, 0);
        func_8001C384(1, 0);
    }
...
void func_80087D70(void) {
    ...
    if ((gPlayerArmWindObject->actionState != 0) && (func_8001C248(1, 3) != 0)) {
        func_8001838C();
        func_8001B014(1, 3);
        func_8001C384(1, 3);
    }
...
void func_800883A8(void) {
    ...
    Set_DecompressHeap(FileSize + 0x80280000);

    if (D_8016523E == 0) {
        func_8001EB68(1, &_603530_ROM_START, &_603530_ROM_END);
        func_8001EB68(2, &_626CF0_ROM_START, &_626CF0_ROM_END);
        func_8001EB68(3, &_627030_ROM_START, &_627030_ROM_END);
        func_8001EB68(4, &_627330_ROM_START, &_627330_ROM_END);
        func_8001EB68(8, &_62CB20_ROM_START, &_62CB20_ROM_END);
        func_8001EB68(9, &_6407D0_ROM_START, &_6407D0_ROM_END);
    } else if (D_8016523E == 1) {
        func_8001EB68(1, &_610A40_ROM_START, &_610A40_ROM_END);
        func_8001EB68(10, &_640F90_ROM_START, &_640F90_ROM_END);
    } else if (D_8016523E == 2) {
        func_8001EB68(1, &_613370_ROM_START, &_613370_ROM_END);
        func_8001EB68(7, &_62C280_ROM_START, &_62C280_ROM_END);
        func_8001EB68(11, &_6414B0_ROM_START, &_6414B0_ROM_END);
    } else if (D_8016523E == 3) {
        func_8001EB68(1, &_6165A0_ROM_START, &_6165A0_ROM_END);
    } else if (D_8016523E == 4) {
        func_8001EB68(1, &_618410_ROM_START, &_618410_ROM_END);
        func_8001EB68(5, &_628770_ROM_START, &_628770_ROM_END);
        func_8001EB68(12, &_6419D0_ROM_START, &_6419D0_ROM_END);
    } else if (D_8016523E == 5) {
        func_8001EB68(1, &_61A940_ROM_START, &_61A940_ROM_END);
    } else if (D_8016523E == 6) {
        func_8001EB68(1, &_620560_ROM_START, &_620560_ROM_END);
        func_8001EB68(6, &_628B10_ROM_START, &_628B10_ROM_END);
    }
}
