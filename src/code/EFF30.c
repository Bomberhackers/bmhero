...
void func_800FEFA0(void)
{
    ...
    sprintf((char *)gDebugTextBuf, "(%d %d %d) ST=%d CG=%d %d",
    ...
    sp50 *= 0x3C;
    sprintf((char *)gDebugTextBuf, "(%d %d %d) R=%d GB=%d", sp54, (s32)gPlayerObject->Pos.y, sp50, (s32)(u8)D_8016E414, (s32)(u16)D_8016E41C);
    debug_print_xy(0x20, 0x20);
...
{
    sprintf((char *)gDebugTextBuf, "PLAY.POS X=%5d Y=%5d Z=%5d", (s32)gObjects[0].Pos.x, (s32)gObjects[0].Pos.y, (s32)gObjects[0].Pos.z);
    debug_print_xy(0x20, 0x10);
    sprintf((char *)gDebugTextBuf, "PLAY.ROT X=%5d Y=%5d Z=%5d", (s32)gObjects[0].Rot.x, (s32)gObjects[0].Rot.y, (s32)gObjects[0].Rot.z);
    debug_print_xy(0x20, 0x20);
    sprintf((char *)gDebugTextBuf, "VIEW.AT  X=%5d Y=%5d Z=%5d", (s32)gView.at.x, (s32)gView.at.y, (s32)gView.at.z);
    debug_print_xy(0x20, 0x30);
    sprintf((char *)gDebugTextBuf, "VIEW.EYE X=%5d Y=%5d Z=%5d", (s32)gView.eye.x, (s32)gView.eye.y, (s32)gView.eye.z);
    debug_print_xy(0x20, 0x40);
    sprintf((char *)gDebugTextBuf, "VIEW.ROT X=%5d Y=%5d Z=%5d", (s32)gView.rot.x, (s32)gView.rot.y, (s32)gView.rot.z);
    debug_print_xy(0x20, 0x50);
