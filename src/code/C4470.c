...
void func_800D3974(void)
{
    ...
    CurrentObject->unk48 = sinf(CurrentObject->unkB8 * 0.0174532925199432955) * 30.0f + CurrentObject->unkB6 - CurrentObject->Pos.y;
    func_80029D04(gCurrentParsedObject);
...
void func_800D4D74(void)
{
    ...
    if (CurrentObject->unkA6 == 0)
    {
        ...
        CurrentObject->Vel.y = 0.0f;
        func_80029C40(gCurrentParsedObject);
        sp30 = sinf(CurrentObject->unk3C * 0.0174532925199432955) * 120.0f + CurrentObject->Pos.x;
        sp28 = cosf(CurrentObject->unk3C * 0.0174532925199432955) * 120.0f + CurrentObject->Pos.z;
        ...
        else
        {
            ...
            sp30 = sinf(CurrentObject->unkA8 * 0.0174532925199432955) * 140.0f + CurrentObject->Pos.x;
            sp28 = cosf(CurrentObject->unkA8 * 0.0174532925199432955) * 140.0f + CurrentObject->Pos.z;
            ...
            {
                sp30 = sinf(CurrentObject->unkAA * 0.0174532925199432955) * 140.0f + CurrentObject->Pos.x;
                sp28 = cosf(CurrentObject->unkAA * 0.0174532925199432955) * 140.0f + CurrentObject->Pos.z;
                sp2C = CurrentObject->Pos.y - 120.0f;
...
void func_800D6684(void)
{
    ...
    {
        CurrentObject->unkA6 -= 1;
        func_800158B4(gPlayerObject->Pos.x - CurrentObject->Pos.x, (gPlayerObject->Pos.y + 60.0f) - CurrentObject->Pos.y, gPlayerObject->Pos.z - CurrentObject->Pos.z, &sp40, &sp3C);
    ...
    {
        CurrentObject->unkB0 = func_80015538(CurrentObject->unk3C, -CurrentObject->unkA8);
        if ((CurrentObject->unkB0 < 6) || (CurrentObject->unkB0 >= 0x163))
        {
            CurrentObject->unk3C = func_80015538(CurrentObject->unk3C, CurrentObject->unkAC);
...
void func_800D7348(void)
{
    ...
    if (CurrentObject->unk132 == 0)
    {
        ...
        CurrentObject->unkA6 = 0x1E;
        CurrentObject->unk44 = 5.0f;
        CurrentObject->unk3C = func_80015538(CurrentObject->unk128, 180.0f);
        func_80029EF8(gCurrentParsedObject, 14.378698f, 1.06089f);
        func_8001BBDC(gCurrentParsedObject, 1);
        CurrentObject->unk108 = 0;
    }
    CurrentObject->Rot.y = func_80015538(CurrentObject->Rot.y, 25.0f);
...
{
    func_80027464(1, &D_80114234, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_800D7704(void)
{
    ...
    if (CurrentObject->unkA6 != 0)
    {
        CurrentObject->unk3C = func_80015538(CurrentObject->unk3C, (CurrentObject->unkAA * 0xA));
        CurrentObject->Rot.y = CurrentObject->unk3C;
...
{
    if ((D_80177A64 == 0) && (gObjects[gCurrentParsedObject].unkA4 == 1))
    {
        gObjects[gCurrentParsedObject].unk132 = 0;
        gObjects[gCurrentParsedObject].unkA4 = 2;
