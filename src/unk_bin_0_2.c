...
u32 D_8024C200_unk_bin_0_2[] = {
    0x00000001, 0x00000000, 0xB8000000, 0x00000000, 0x001E0000, 0xFFE20000, 0x04000400, 
...
Gfx D_8024C630_unk_bin_0_2[] = {
    ...
    gsDPLoadTextureBlock_4b(D_01000000_unk_bin_0_2, G_IM_FMT_CI, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
...
Gfx D_8024C6C8_unk_bin_0_2[] = {
    ...
    gsDPLoadTextureBlock_4b(D_010002D0_unk_bin_0_2, G_IM_FMT_CI, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPEndDisplayList(),
};
