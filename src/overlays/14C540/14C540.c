...
void func_803303BC_unk_bin_2(void)
{
    ...
    {
        sp34 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.x = -((cosf((sp48 * D_80336208_unk_bin_2)) * -D_80336364) + D_80336364) - sp3C;
    ...
    {
        sp34 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.x = -((cosf((f32)((f64)sp48 * D_80336218_unk_bin_2)) * -D_80336364) + D_80336364) - sp3C;
        sp2C = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.z = (sinf((f32)((f64)sp48 * D_80336220_unk_bin_2)) * -D_80336364) - sp38;
        sp30 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.y = sp40;
        sp40 -= (f64)D_80336370;
        sp48 -= D_80336368;
    }
...
void func_803308C4_unk_bin_2(s32 arg0)
{
    ...
    {
        sp3C = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.x = -((cosf((f32)((f64)sp40 * D_80336240_unk_bin_2)) * -D_80336364) + D_80336364) - sp48;
        sp34 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.z = (sinf((f32)((f64)sp40 * D_80336248_unk_bin_2)) * -D_80336364) - sp44;
        gObjects[D_80336080_unk_bin_2[sp4E]].Pos.y += sp30,
            sp38 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.y;
        sp40 += D_80336368;
    }
    ...
    for (sp4E = D_80134801 - 1; sp4E >= 0; sp4E--)
    {
        sp3C = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.x = -((cosf((f32)((f64)sp40 * D_80336250_unk_bin_2)) * -D_80336364) + D_80336364) - sp48;
        sp34 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.z = (sinf((f32)((f64)sp40 * D_80336258_unk_bin_2)) * -D_80336364) - sp44;
        gObjects[D_80336080_unk_bin_2[sp4E]].Pos.y += sp30,
            sp38 = gObjects[D_80336080_unk_bin_2[sp4E]].Pos.y;
        sp40 -= D_80336368;
    }
...
void func_80331238_unk_bin_2(f32 arg0, f32 arg1)
{
    ...
    else
    {
        ...
        gObjects[D_80336080_unk_bin_2[D_80134801]].Scale.x =
            gObjects[D_80336080_unk_bin_2[D_80134801]].Scale.y =
                gObjects[D_80336080_unk_bin_2[D_80134801]].Scale.z = arg1;

        if (D_80134801 == 1)
        {
            gObjects[0xC].Scale.x =
                gObjects[0xC].Scale.y = gObjects[0xC].Scale.z = arg1;
        }
        else if (D_80134801 == 3)
        {
            gObjects[0xF].Scale.x =
                gObjects[0xF].Scale.y =
                    gObjects[0xF].Scale.z = arg1;
        }
        else if (D_80134801 == 4)
        {
            gObjects[0x11].Scale.x =
                gObjects[0x11].Scale.y =
                    gObjects[0x11].Scale.z = arg1;
        }
    }
}
...
void func_8033161C_unk_bin_2(void)
{
    ...
    gObjects[0x14].Scale.x =
        gObjects[0x14].Scale.y =
            gObjects[0x14].Scale.z = 2.5f;
...
void func_80331728_unk_bin_2(void)
{
    ...
    sp24 = (f32)(((f64)gObjects[D_80336080_unk_bin_2[D_80336361]].Pos.z * D_80336270_unk_bin_2) + D_80336278_unk_bin_2);
    gObjects[0x14].Scale.x =
        gObjects[0x14].Scale.y =
...
void func_80331920_unk_bin_2(void)
{
    ...
    else
    {
        ...
        if ((f64)gObjects[0x14].Scale.x < D_80336290_unk_bin_2)
        {
            gObjects[0x14].Scale.x =
                gObjects[0x14].Scale.y =
                    gObjects[0x14].Scale.z = D_80336298_unk_bin_2;
        }
...
void func_80331B9C_unk_bin_2(void)
{
    ...
    sp20 = (f32)(((f64)gObjects[D_80336080_unk_bin_2[D_80336361]].Pos.z * D_803362B0_unk_bin_2) + D_803362B8_unk_bin_2);
    sp1C = (f32)(((f64)gObjects[D_80336080_unk_bin_2[D_80336361]].Pos.z * D_803362C0_unk_bin_2) + D_803362C8_unk_bin_2);
...
void func_80332094_unk_bin_2(s32 arg0)
{
    ...
    for (sp1E = 0; sp1E < D_801039D4[D_80134801].Unk01; sp1E++)
    {
        ...
        gObjects[D_80336140_unk_bin_2[sp1E]].Pos.x = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.x - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.x * 16.0));
        gObjects[D_80336140_unk_bin_2[sp1E]].Pos.y = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.y - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.y * 42.0));
        ...
        gObjects[D_80336158_unk_bin_2[sp1E]].Pos.x = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.x - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.x * 46.0));
        gObjects[D_80336158_unk_bin_2[sp1E]].Pos.y = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.y - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.y * 42.0));
        ...
        gObjects[D_8033614C_unk_bin_2[sp1E]].Pos.x = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.x - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.x * -58.0));
        gObjects[D_8033614C_unk_bin_2[sp1E]].Pos.y = (f32)((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Pos.y - ((f64)gObjects[D_80336128_unk_bin_2[sp1E]].Scale.y * -36.0));
...
void func_80334BE0_unk_bin_2(void)
{
    ...
    if ((D_80324990 == 0) && (D_80324992 == 0))
    {
        ...
        {
            if (((D_80134801 + D_80324990) < 0) || ((D_80134801 + D_80324990) >= D_80336360) || ((func_800600B8(0, (s32)D_80134801) == 0) && (D_80324990 == 1)))
            {
                D_80324990 = 0;
            }
            else
