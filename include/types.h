...
typedef struct UnkStruct_D_80324994_1_s {
    /* 0x00 */ u32 unk0;
    /* 0x04 */ u32 unk4;
    /* 0x08 */ u32 unk8;
    /* 0x0C */ s8 unkC;                             /* inferred */
    /* 0x0D */ s8 unkD;                             /* inferred */
    /* 0x0E */ char padE[2];                        /* maybe part of unkD[3]? */
    /* 0x10 */ struct UnkStruct8016C298_1 *unk10;
} UnkStruct_D_80324994_1;                           /* size = 0x14 */

struct UnkStruct_D_80324994 {
    UnkStruct_D_80324994_1 unk0[1]; // Unknown size
};
