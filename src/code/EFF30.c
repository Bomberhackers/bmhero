...
void func_800FEFA0(void) {
    ...
    sprintf(&gDebugTextBuf, "(%d %d %d) ST=%d CG=%d %d",
            (s32)gPlayerObjectPointer->Pos.x, (s32)gPlayerObjectPointer->Pos.y, (s32) gPlayerObjectPointer->Pos.z,
            gPlayerObjectPointer->unkA4, D_80165290[gObjects[0].Unk140[0]].unk14,
            gPlayerObjectPointer->unk108
        );
    debug_print_xy((s8*)0x20, (s8*)0x10);
    sp54 = (s32)gPlayerObjectPointer->Pos.x / 60;
    sp4C = (s32)gPlayerObjectPointer->Pos.x % 60;
    ...
    sp54 *= 0x3C;
    sp50 = (s32) gPlayerObjectPointer->Pos.z / 60;
    sp48 = (s32) gPlayerObjectPointer->Pos.z % 60;
    ...
    sp50 *= 0x3C;
    sprintf(&gDebugTextBuf, "(%d %d %d) R=%d GB=%d", sp54, (s32) gPlayerObjectPointer->Pos.y, sp50, (s32) (u8) D_8016E414, (s32) (u16) D_8016E41C);
    debug_print_xy((s8* )0x20, (s8* )0x20);
...
void func_800FF43C(void) {
    sprintf(&gDebugTextBuf, "PLAY.POS X=%5d Y=%5d Z=%5d", (s32) gObjects[0].Pos.x, (s32) gObjects[0].Pos.y, (s32) gObjects[0].Pos.z);
    debug_print_xy((s8* )0x20, (s8* )0x10);
    sprintf(&gDebugTextBuf, "PLAY.ROT X=%5d Y=%5d Z=%5d", (s32) gObjects[0].Rot.x, (s32) gObjects[0].Rot.y, (s32) gObjects[0].Rot.z);
    debug_print_xy((s8* )0x20, (s8* )0x20);
