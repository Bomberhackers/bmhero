...
void func_800C04C4(void) {
    ...
    if (sp44->unk132 == 0) {
        ...
        sp44->unk40 =
            (sp44->unkA8 * 0x5A + 0x168 >= 0xB5)
                ? ((sp44->unkA8 * 0x5A + 0x168 >= 0x168 ? sp44->unkA8 * 0x5A : sp44->unkA8 * 0x5A + 0x168))
                : ((sp44->unkA8 * 0x5A + 0x168 < 0) ? sp44->unkA8 * 0x5A + 0x2D0 : sp44->unkA8 * 0x5A + 0x168);
    ...
    sp44->Rot.x = ((sp44->Rot.x + 12.0f) > 180.0f)
                      ? ((sp44->Rot.x + 12.0f >= 360.0f) ? (sp44->Rot.x + 12.0f) - 360.0f : sp44->Rot.x + 12.0f)
                  : ((sp44->Rot.x + 12.0f < 0.0f)) ? (sp44->Rot.x) + 360.0f + 12.0f
                                                   : sp44->Rot.x + 12.0f;
...
void func_800C0F18(void) {
    ...
    if (sp3C->unkA6 <= 0) {
        ...
        sp3C->Rot.x = ((sp3C->Rot.x + 12.0f) > 180.0f)
                      ...
                      : ((sp3C->Rot.x + 12.0f < 0.0f)) ? (sp3C->Rot.x) + 360.0f + 12.0f
                                                       : sp3C->Rot.x + 12.0f;
