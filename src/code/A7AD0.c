...
void func_800B725C(void) {
    ...
    sp1C = (s32) gObjects[gCurrentParsedObject].action_state;
    switch (sp1C) {
        case 1:
            func_800B5814();
            break;
...
void func_800BFA14(void) {
    ...
    sp24 = &gObjects[gCurrentParsedObject];
    if (sp24->unkE6[0] == -1) {
        switch (sp24->action_state) { /* irregular */
            case 1:
                func_800BF75C();
                break;
            case 2:
