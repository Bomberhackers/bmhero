...
void func_803325E4_unk_bin_20() {
    ...
    if (gObjects[obj->unkC2].action_state == 0xB) {
        if (obj->unk132 == 0) {
            obj->unk132++;
            obj->unk44 = 9.0f;
            obj->unk3C = obj->Rot.y;
