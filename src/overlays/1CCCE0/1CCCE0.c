...
void func_803301FC_unk_bin_35(void) {
    ...
    if (D_80177A64 == 0) {
        obj->unkA4 = 6;
        obj->unk132 = 0;
    } else if ((D_80177A64 == 1) && (obj->unkA4 < 6)) {
        obj->unkA4 = 5;
        obj->unk132 = 0;
        obj->unk108 = 0x14;
    }
...
void func_803312E8_unk_bin_35(void) {
    ...
    if (func_80330E68_unk_bin_35(obj, 0x3C0) != 0) {
        if (D_8016E120 == 0) {
            ...
            D_8016E130 = sinf((f32) ((f64) obj->Rot.y * 0.017453292519943295)) * 20.0f;
            D_8016E138 = 0.0f;
            D_8016E1B4 = cosf((f32) ((f64) obj->Rot.y * 0.017453292519943295)) * 20.0f;
        }
    } else {
        D_8016E120 = 0;
        obj->unkA4 = 4;
