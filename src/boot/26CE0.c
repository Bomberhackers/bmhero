...
s32 func_8002A1FC(s32 arg0, f32 arg1) {
    ...
    spC = &gObjects[arg0];
    sp8 = gPlayerObjectPointer->Pos.x - spC->Pos.x;
    sp4 = (gPlayerObjectPointer->Pos.y + 60.0f) - spC->Pos.y;
    sp0 = gPlayerObjectPointer->Pos.z - spC->Pos.z;
...
s32 func_8002A2EC(s32 arg0, f32 arg1) {
    ...
    spC = &gObjects[arg0];
    sp8 = gPlayerObjectPointer->Pos.x - spC->Pos.x;
    sp4 = gPlayerObjectPointer->Pos.z - spC->Pos.z;
...
f32 func_8002A46C(s32 arg0) {
    func_80015634(gPlayerObjectPointer->Pos.x - gObjects[arg0].Pos.x,
                  gPlayerObjectPointer->Pos.z - gObjects[arg0].Pos.z);
    return;
}

f32 func_8002A4E0(s32 arg0) {
    func_800156C4(gPlayerObjectPointer->Pos.x - gObjects[arg0].Pos.x,
                  (gPlayerObjectPointer->Pos.y + 60.0f) - gObjects[arg0].Pos.y);
    return;
}
