...
void func_800CC040(void)
{
    ...
    {
        sp24 = func_80027464(3, &D_8011400C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, 0.0f);
        if (sp24 != -1)
        {
    ...
    {
        sp24 = func_80027464(1, &D_80114030, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, 0.0f);
        if (sp24 != -1)
        {
            gObjects[sp24].unkA4 = 3;
        }
    }
}
...
void func_800CC220(void)
{
    ...
    if ((D_80177A64 == 1) && (sp4->unkA4 == 1) && (sp4->unkA8 == 0))
    {
        sp4->unkA8 = 0xA;
        sp4->unk108 = 0x32;
    }
...
void func_800CC2E0(void)
{
    ...
    if (sp44->unk108 >= 2)
    {
        func_8001BB34(gCurrentParsedObject, !(sp44->unk108 & 1));
    }
    else
    {
...
void func_800CCB90(void)
{
    ...
    sp24 = func_80027464(4, &D_8011406C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        sp20 = gObjects[sp24].unkE8[1];
...
void func_800CCCE4(void)
{
    if (D_80177A64 == 0)
    {
        gObjects[gCurrentParsedObject].unkA4 = 9;
...
void func_800CD808(void)
{
    ...
    gObjects[sp58].Pos.x =
        gObjects[sp54].Pos.x =
            gObjects[sp50].Pos.x = sp5C->Pos.x;
    ...
    gObjects[sp58].Pos.z =
        gObjects[sp54].Pos.z =
            gObjects[sp50].Pos.z = sp5C->Pos.z;

    gObjects[sp58].Rot.y =
        gObjects[sp54].Rot.y =
            gObjects[sp50].Rot.y = sp5C->Rot.y;

    gObjects[sp58].unk3C =
        gObjects[sp54].unk3C =
            gObjects[sp50].unk3C = sp5C->unk3C;
...
void func_800CDFD4(void)
{
    ...
    if (sp2C->unkAA != 0)
    {
        ...
        gObjects[sp28].unk3C = sp2C->unk3C;
        gObjects[sp28].Rot.y = sp2C->Rot.y;
        gObjects[sp24].unk3C = sp2C->unk3C;
...
void func_800CECC0(void)
{
    ...
    if (sp3C->unk132 == 0)
    {
        ...
        if (sp38 != -1)
        {
            gObjects[sp38].unk108 = 0x14;
        }
        if (sp34 != -1)
        {
            gObjects[sp34].unk108 = 0x14;
            ;
        }
        if (sp30 != -1)
        {
            gObjects[sp30].unk108 = 0x14;
        }
...
void func_800CF4B4(void)
{
    ...
    sp24 = func_80027464(1, &D_8011409C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkB6 = D_80165100->unkA;
    }
...
{
    func_80027464(1, &D_801140B4, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}

void func_800CFC8C(void)
{
    if ((D_80177A64 == 0) && (gObjects[gCurrentParsedObject].unkA4 != 6))
    {
        gObjects[gCurrentParsedObject].unk132 = 0;
...
{
    func_80027464(1, &D_801140CC, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
    ...
    if (sp3C->unkA6 == 0)
    {
        if (sp3C->unkA8 < 0xA)
        {
            ...
            if (sp38 != -1)
            {
                ...
                gObjects[sp38].unk3C = gObjects[sp38].Rot.y = 0.0f;
...
{
    func_80027464(1, &D_801140E4, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
