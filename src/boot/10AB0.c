...
void func_80010B6C(struct UnkInputStruct80010B6C* arg0, struct UnkInputStruct80010B6C* arg1,
                   struct UnkInputStruct80010B6C* arg2, f32 arg3);           // in file
...
void* func_800100E8(void* arg0, s32 arg1) {
    ...
    if (D_80055D50[arg1].unk2C != 0) {
        for (sp1C = D_80055D50[arg1].unk2C + arg1, sp18 = 1; D_80055D50[sp1C].unk28 != 0;
             sp1C += D_80055D50[sp1C].unk28, sp18++) {}
        sp24->unk10 = sp18;
    ...
    switch (arg0->unk0) {
        case 0x31:
            ...
            if (spC[sp18] == sp14) {
                ...
                sp10 = sp4[sp18 - 1] + (((sp4[sp18] - sp4[sp18 - 1]) / (f32) (spC[sp18] - spC[sp18 - 1])) *
                                        (arg1 - (f32) spC[sp18 - 1]));
            }
            break;
    }
...
void func_80010B6C(struct UnkInputStruct80010B6C* arg0, struct UnkInputStruct80010B6C* arg1,
                   struct UnkInputStruct80010B6C* arg2, f32 arg3) {
...
void func_80011084(struct UnkInputStruct80011084* arg0, f32 arg1) {
    ...
    if ((arg0->unk14 | arg0->unk10) != 0) {
        ...
        func_80010B6C((struct UnkInputStruct80010B6C*) (sp20 + 0x3), (struct UnkInputStruct80010B6C*) (sp1C + 0x3),
                      (struct UnkInputStruct80010B6C*) (sp18 + 0x3), arg1);
