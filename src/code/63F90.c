...
void func_80072854(void)
{
    ...
    player_x = gObjects[0].Pos.x;
    player_y = gObjects[0].Pos.y;
    player_z = gObjects[0].Pos.z;

    sp2C = func_80065ACC();
    sp28 = (s32)sp2C->unk4;
    sp24 = (sp2C->unk1C * sp2C->unk22 * 0x3C) + sp28;
    gView.at.x = gObjects[0].Pos.x;
    gView.at.y = gObjects[0].Pos.y + 100.0f;
    gView.at.z = gObjects[0].Pos.z;
}
