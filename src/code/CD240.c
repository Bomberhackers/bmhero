...
void func_800DAE20(void) {
    ...
    sp30 = Math_Random(-6);
    sp34->moveAngle = Math_WrapAngle(sp34->moveAngle, (f32) sp30);
    sp34->Rot.y = (f32) sp34->moveAngle;
    if (sp34->unkA8 == 0) {
        if (sp34->unkA6 < 0xF) {
            sp34->Vel.y = 1.0f;
...
void func_800DB910(void) {
    ...
    sp1C->Rot.y = Get_AngleToPlayer(gCurrentParsedObject);
    sp1C->moveAngle = (f32) sp1C->Rot.y;
...
void func_800DBA0C(void) {
    ...
    sp2C->Rot.y = Get_AngleToPlayer(gCurrentParsedObject);
    sp2C->moveAngle = (f32) sp2C->Rot.y;
    if (func_8001B4AC(gCurrentParsedObject, 0) != 0) {
        sp2C->Vel.z = 0.0f;
        sp2C->Vel.x = sp2C->Vel.y = sp2C->Vel.z;
        sp2C->actionState = 5;
...
void func_800DBCFC(void) {
    ...
    if (sp44->unk132 == 0) {
        ...
        sp44->moveAngle = Get_AngleToPlayer(gCurrentParsedObject);
        sp44->Rot.y = (f32) sp44->moveAngle;
        sp44->moveSpeed = 15.0f;
...
void func_800DC984(void) {
    ...
    if (sp34->Rot.x < 139.0f) {
        sp34->Rot.x = Math_WrapAngle(sp34->Rot.x, 10.0f);
    }
    if (func_8001B4AC(gCurrentParsedObject, 0) != 0) {
        sp34->actionState = 3;
        sp34->unk132 = 0U;
...
void func_800DCFAC(void) {
    ...
    if ((func_80028FA0(gCurrentParsedObject) != 0) &&
        ((sp24->interactingObjID == 0xA2) || (sp24->interactingObjID == 0xA3))) {
        func_800E3EE4();
        return;
    }
    func_8002A8B4(gCurrentParsedObject, 6.0f);
...
void func_800DD300(void) {
    ...
    if (func_80028FA0(gCurrentParsedObject) != 0) {
        if ((sp44->interactingObjID == 0xA2) || (sp44->interactingObjID == 0xA3)) {
            func_800E3EE4();
            return;
        } else {
            func_80029B60(gCurrentParsedObject);
...
void func_800DDAA8(void) {
    ...
    if ((func_80028FA0(gCurrentParsedObject) != 0) &&
        (((sp24->interactingObjID == 0xA1)) || (sp24->interactingObjID == 0xA3))) {
        func_800E3EE4();
        return;
    }
    func_8002A8B4(gCurrentParsedObject, 6.0f);
...
void func_800DDE08(void) {
    ...
    if (func_80028FA0(gCurrentParsedObject) != 0) {
        if ((sp44->interactingObjID == 0xA1) || (sp44->interactingObjID == 0xA3)) {
            func_800E3EE4();
            return;
        } else {
            func_80029B60(gCurrentParsedObject);
...
void func_800DE1E8(void) {
    ...
    if (sp3C->unk132 == 0) {
        ...
        sp3C->Rot.y = (f32) sp3C->moveAngle;
        sp3C->moveSpeed = 6.0f;
    }
    if ((func_8001B62C(gCurrentParsedObject, 0) > 20.0f) && (sp3C->unkAA == 0)) {
        sp38 = func_80027464(1, &D_80114360, sp3C->Pos.x, sp3C->Pos.y + 60.0f, sp3C->Pos.z, sp3C->moveAngle);
        if (sp38 != -1) {
            func_8001ABF4(sp38, 0, 3, &D_8011935C);
            func_80026F10(gCurrentParsedObject, sp38);
            gObjects[sp38].moveAngle = gObjects[sp38].Rot.y = sp3C->moveAngle;
            gObjects[sp38].unkB2 = 1;
            sp3C->unkAA = (s16) (sp3C->unkAA + 1);
        }
    }
    if (func_80028FA0(gCurrentParsedObject) != 0) {
        if ((sp3C->interactingObjID == 0xA1) || (sp3C->interactingObjID == 0xA3)) {
            func_800E3EE4();
            return;
        } else {
            func_80029B60(gCurrentParsedObject);
...
void func_800DE95C(void) {
    ...
    if ((func_80028FA0(gCurrentParsedObject) != 0) &&
        (((sp24->interactingObjID == 0xA2)) || (sp24->interactingObjID == 0xA1))) {
        func_800E3EE4();
        return;
    }
    sp24->Rot.y = Get_AngleToPlayer(gCurrentParsedObject);
    sp24->moveAngle = (f32) sp24->Rot.y;
    if (func_8002A0D0(gCurrentParsedObject, 0, 0, 0) == 1) {
        sp24->actionState = 3;
        sp24->unk132 = 0U;
    }
...
void func_800DECE0(void) {
    ...
    if ((func_80028FA0(gCurrentParsedObject) != 0) &&
        (((sp3C->interactingObjID == 0xA2)) || (sp3C->interactingObjID == 0xA1))) {
        func_800E3EE4();
        return;
    }
    if (func_8001B62C(gCurrentParsedObject, 0) > 10.0f) {
...
void func_800DF034(void) {
    ...
    if (func_80028FA0(gCurrentParsedObject) != 0) {
        if ((sp44->interactingObjID == 0xA1) || (sp44->interactingObjID == 0xA2)) {
            func_800E3EE4();
            return;
        } else {
            func_80029B60(gCurrentParsedObject);
...
void func_800E0154(void) {
    ...
    if ((func_8001B62C(gCurrentParsedObject, 0) > 20.0f) && (sp44->unkAA == 0)) {
        sp32 = 0;
        do {
            sp40 = func_80027464(1, &D_80114378, sp44->Pos.x, sp44->Pos.y + 120.0f, sp44->Pos.z, sp44->moveAngle);
            if (sp40 != -1) {
...
void func_800E119C(void) {
    ...
    if (func_8001B62C(gCurrentParsedObject, 0) > 10.0f) {
        if ((func_8001B62C(gCurrentParsedObject, 0) > 25.0f) && (sp44->unkAA == 1)) {
            sp32 = 0;
            do {
                sp40 = func_80027464(1, &D_80114384, sp44->Pos.x, sp44->Pos.y + 120.0f, sp44->Pos.z, sp44->moveAngle);
                if (sp40 != -1) {
                    func_8001ABF4(sp40, 0, 3, &D_801193AC);
                    func_80026F10(gCurrentParsedObject, sp40);
                    if (sp32 == 0) {
                        gObjects[sp40].moveAngle = 0.0f;
                    } else if (sp32 == 1) {
                        gObjects[sp40].moveAngle = 90.0f;
                    } else if (sp32 == 2) {
                        gObjects[sp40].moveAngle = 180.0f;
                    } else {
                        gObjects[sp40].moveAngle = 270.0f;
                    }
    ...
    if (sp2C->unkAA == 1) {
        ...
        if (sp2C->actionState != 2) {
            if (sp2C->unkB0 < 0x3C) {
                ...
                sp2C->Vel.y = sp28;
                sp2C->moveSpeed = (f32) ((f64) sp2C->moveSpeed * D_80115460);
            } else {
                sp2C->actionState = 2;
            }
        }
    ...
    if (sp2C->unkAA == 1) {
        ...
        if (sp2C->actionState != 2) {
            if (sp2C->unkB0 < 0x3C) {
                ...
                sp2C->Vel.y = sp28;
                sp2C->moveSpeed = (f32) ((f64) sp2C->moveSpeed * D_80115468);
            } else {
                sp2C->actionState = 2;
            }
        }
...
void func_800E39F4(void) {
    ...
    sp24 = &gObjects[gCurrentParsedObject];
    sp20 = func_80027464(1, &D_80114390, sp24->Pos.x, sp24->Pos.y, sp24->Pos.z, sp24->moveAngle);
    if (sp20 != -1) {
...
void func_800E3B40(void) {
    ...
    sp24 = &gObjects[gCurrentParsedObject];
    sp20 = func_80027464(1, &D_8011439C, sp24->Pos.x, sp24->Pos.y, sp24->Pos.z, sp24->moveAngle);
    if (sp20 != -1) {
...
void func_800E3C8C(void) {
    ...
    sp24 = &gObjects[gCurrentParsedObject];
    sp20 = func_80027464(1, &D_801143A8, sp24->Pos.x, sp24->Pos.y, sp24->Pos.z, sp24->moveAngle);
    if (sp20 != -1) {
...
void func_800E3EE4(void) {
    ...
    sp44 = sp4C->Pos.y;
    sp40 = sp4C->Pos.z;
    sp3C = gObjects[sp4C->interactingObjIdx].Pos.x;
    sp38 = gObjects[sp4C->interactingObjIdx].Pos.y;
    sp34 = gObjects[sp4C->interactingObjIdx].Pos.z;
    sp30 = func_80027464(1, &D_801143B4, (sp48 + sp3C) / 2.0f, (sp44 + sp38) / 2.0f, (sp40 + sp34) / 2.0f, sp4C->moveAngle);
    if (sp30 != -1) {
        func_8001ABF4(sp30, 0, 0, &D_8011940C);
        gObjects[sp30].Rot.y = sp4C->Rot.y;
        switch (sp4C->objID) {
            case 0xA1:
                if (sp4C->interactingObjID == 0xA2) {
    ...
    func_8002B114(sp4C->interactingObjIdx);
    func_8002B114(gCurrentParsedObject);
}
...
void func_800E45C4(void) {
    ...
    if (sp24->unk132 == 0) {
        sp24->unk132 = (u8) (sp24->unk132 + 1);
        sp24->unkB2 = (s16) sp24->actionState;
...
void func_800E4728(void) {
    ...
    if (sp34->unk132 == 0) {
        sp34->unk132 = (u8) (sp34->unk132 + 1);
        sp34->unkB2 = (s16) sp34->actionState;
...
void func_800E4E3C(void) {
    ...
    if (sp2C->unk132 == 0) {
        sp2C->unk132 = (u8) (sp2C->unk132 + 1);
        sp2C->unkB2 = (s16) sp2C->actionState;
...
void func_800E589C(void) {
    ...
    sp4 = &gObjects[gCurrentParsedObject];
    if (D_80177A64 == 0) {
        if ((sp4->interactingObjID == 9) || (sp4->interactingObjID == 0x10)) {
            sp4->damageState = 0;
            sp4->actionState = 4;
        }
    } else {
...
void func_800E64D0(void) {
    ...
    if (D_80177A64 == 0) {
        ...
        sp4->actionState = (s16) sp4->unkB2;
        sp4->moveSpeed = 0.0f;
        sp4->Vel.x = sp4->Vel.z = sp4->moveSpeed;
        sp4->unk132 = 0;
    }
}
...
void func_800E683C(void) {
    ...
    if (sp3C->unk132 == 0) {
        sp3C->unk132 = (u8) (sp3C->unk132 + 1);
        sp3C->unkB2 = (s16) sp3C->actionState;
...
void func_800E6D2C(void) {
    ...
    func_8002A8B4(gCurrentParsedObject, 6.0f);
    sp24->Rot.y = (f32) sp24->moveAngle;
    sp24->Rot.y = Math_WrapAngle(sp24->Rot.y, 270.0f);
    if (func_8001B4AC(gCurrentParsedObject, 0) != 0) {
        if (sp24->unkA6 == 0) {
            sp24->actionState = 7;
        } else {
...
void func_800E6E80(void) {
    ...
    func_8002A8B4(gCurrentParsedObject, 6.0f);
    sp2C->Rot.y = (f32) sp2C->moveAngle;
    sp2C->Rot.y = Math_WrapAngle(sp2C->Rot.y, 270.0f);
    func_80029C40(gCurrentParsedObject);
    ...
    if (func_8002A1FC(gCurrentParsedObject, 240.0f) != 0) {
        sp2C->moveSpeed = 0.0f;
        sp2C->Vel.x = sp2C->Vel.z = sp2C->moveSpeed;
        sp2C->actionState = 8;
        sp2C->unk132 = 0U;
    }
}
...
void func_800E8250(void) {
    ...
    if (sp1C->unk132 == 0) {
        sp1C->unk132 = (u8) (sp1C->unk132 + 1);
        sp1C->unkB2 = (s16) sp1C->actionState;
        sp1C->Vel.y = 48.0f;
        sp1C->unk13A = 0;
    }
    sp1C->Rot.y = Math_WrapAngle(sp1C->Rot.y, 36.0f);
    sp1C->moveAngle = (f32) sp1C->Rot.y;
    if (sp1C->Vel.y <= 0.0f) {
        sp1C->actionState = 3;
        sp1C->unk132 = 0U;
...
void func_800E839C(void) {
    ...
    sp24->moveAngle = Get_AngleToPlayer(gCurrentParsedObject);
    sp24->Rot.y = (f32) sp24->moveAngle;
    sp24->Rot.y = Math_WrapAngle(sp24->Rot.y, 45.0f);
    if (func_8001B4AC(gCurrentParsedObject, 0) != 0) {
        sp24->actionState = 4;
        sp24->unk132 = 0U;
    }
...
void func_800E84D4(void) {
    ...
    if (sp24->unk132 == 0) {
        sp24->unk132 = (u8) (sp24->unk132 + 1);
        sp24->unkB2 = (s16) sp24->actionState;
        sp24->moveSpeed = 18.0f;
        sp24->Vel.y = -6.0f;
        sp24->unkA6 = 0;
        func_8001C0EC(gCurrentParsedObject, 0, 2, 0xB5, &D_801198D0);
    }
    if (sp24->unkA6 == 1) {
        sp24->moveSpeed = (f32) (sp24->moveSpeed - 2.0f);
        if (sp24->moveSpeed <= 0.0f) {
            sp24->moveSpeed = 0.0f;
            sp24->Vel.z = 0.0f;
            sp24->Vel.x = (f32) sp24->Vel.z;
            sp24->unkA6 = 2;
...
void func_800E8934(void) {
    ...
    sp24->moveSpeed = (f32) (sp24->moveSpeed - 1.0f);
    func_80029C40(gCurrentParsedObject);
...
void func_800E90C8(void) {
    ...
    if (D_80177A64 == 0) {
        ...
        spC->damageState = 0x3C;
        sp6 = 0;
        do {
            gObjects[spC->unkE8[sp6]].damageState = 0x3C;
        } while (++sp6 < 3);
        spC->actionState = (s16) spC->unkB2;
    } else {
        spC->actionState = (s16) spC->unkB2;
    }
}
...
void func_800E9420(void) {
    ...
    if ((sp34->unkA6 == 3)) {
        if (gObjects[sp34->unkE8[1]].Rot.z < 19.0f) {
            ...
            sp2E = 0;
            do {
                gObjects[sp34->unkE8[sp2E]].damageState = -1;
            } while (++sp2E < 3);
        }
    }
}
...
void func_800E9AFC(void) {
    ...
    if (sp34->unk132 == 0) {
        sp34->unk132 = (u8) (sp34->unk132 + 1);
        sp34->unkB2 = (s16) sp34->actionState;
        sp34->moveAngle = 180.0f;
        sp34->moveSpeed = 24.0f;
...
void func_800EB01C(void) {
    ...
    if (sp34->unk132 == 0) {
        ...
        sp30 = 0;
        do {
            gObjects[sp34->unkE8[sp30]].damageState = -1;
        } while (++sp30 < 3);
        func_8001C0EC(gCurrentParsedObject, 0, 3, 0xC3, &D_801198EC);
        func_8001C0EC((s32) sp34->unkE8[2], 0, 0, 0xC5, &D_8011990C);
...
void func_800EBFA0(void) {
    ...
    if ((sp24->unkB2 == 4) && (gPlayerObject->damageState != 0) && (func_8002A2EC(gCurrentParsedObject, 60.0f) != 0) &&
        (sp24->unk132 == 1)) {
        sp24->unk132 = (u8) (sp24->unk132 + 1);
    }
...
void func_800EC144(void) {
    ...
    if ((sp1C->unkB2 == 4) && (gPlayerObject->damageState != 0) && (func_8002A2EC(gCurrentParsedObject, 60.0f) != 0)) {
        func_8001BBDC(gCurrentParsedObject, 0);
        sp1C->actionState = 3;
        sp1C->unk132 = 0U;
        func_80284DF8();
...
void func_800ECC54(void) {
    ...
    if (sp2C->unk132 == 0) {
        ...
        if (sp2C->unkA8 == 0) {
            sp28 = func_80027464(1, &D_801144EC, sp2C->Pos.x, sp2C->Pos.y + 165.0f, sp2C->Pos.z, sp2C->moveAngle);
            if (sp28 != -1) {
...
void func_800EDDE4(void) {
    ...
    if (sp24 != 0.0f) {
        sp2C->unk40 = Math_WrapAngle(sp2C->unk40, 1.0f * sp24);
    }
    sp2C->Rot.x = Math_WrapAngle(450.0f, -sp2C->unk40);
    if (func_8001B4AC(gCurrentParsedObject, 0) != 0) {
        sp2C->actionState = 3;
        sp2C->unk132 = 0U;
    }
...
f32 func_800EE1F4(s32 arg0) {
    return Math_CalcAngleRotated(gPlayerObject->Pos.x - gObjects[arg0].Pos.x,
...
void func_800F7A0C(void) {
    ...
    if (sp1C->unk132 == 0) {
        ...
        sp1C->moveSpeed = 0.0f;
        sp1C->moveAngle = (f32) sp1C->moveSpeed;
        sp1C->unkB0 = 1;
    }
    if (sp1C->unkA6 == 0) {
        return;
    ...
    if (sp1C->unkA8 <= 0) {
        sp1C->unkB0 = 2;
        sp1C->actionState = (s16) sp1C->unkB0;
        sp1C->unk132 = 0U;
    }
}
...
void func_800F82EC(void) {
    ...
    if (D_80177A64 == 0) {
        ...
        sp4 = (s32) spC->unkE8[1];
        if (sp8 != -1) {
            if (gObjects[sp8].interactingObjIdx != -1) {
                spC->actionState = 2;
                spC->unk132 = 0;
            }
        }
        if (sp4 != -1) {
            if (gObjects[sp4].interactingObjIdx != -1) {
                spC->actionState = 2;
                spC->unk132 = 0;
            }
        }
...
void func_800F84F8(void) {
    ...
    if (sp24->unk132 == 0) {
        ...
        if ((sp20 != -1)) {
            if (gObjects[sp20].interactingObjIdx != -1) {
...
void func_800F9120(void) {
    ...
    sp4 = &gObjects[gCurrentParsedObject];
    if ((D_80177A64 == 1) && (sp4->actionState == 1)) {
        sp4->actionState = 2;
        sp4->unk132 = 0;
    }
}
...
void func_800F98C4(void) {
    ...
    if (sp20 != -1) {
        sp24 = &gObjects[sp20];
        sp24->objID = (s16) D_80165100->unk0;
...
void func_800FA54C(void) {
    ...
    if (sp34->unk132 == 0) {
        ...
        sp34->unk48 = 6.0f;
        sp34->moveSpeed = 0.0f;
        sp34->moveAngle = (f32) sp34->moveSpeed;
    }
    sp34->Vel.z = 0.0f;
    sp34->Vel.x = sp34->Vel.y = sp34->Vel.z;
...
void func_800FAA88(void) {
    ...
    if (sp2C->unk132 == 0) {
        sp2C->unk132 = 1U;
        sp2C->unk40 = Math_WrapAngle(sp2C->unk40, 180.0f);
        sp2C->unkA8 = 0xF0;
        sp2C->unk48 = (f32) ((s16) sp2C->unkA8 / 4);
        sp2C->moveSpeed = 0.0f;
        sp2C->moveAngle = (f32) sp2C->moveSpeed;
        func_800175F0(gCurrentParsedObject, 0, 0x31, -1, 0);
    }
    if (sp2C->unkA8 <= 0) {
        sp2C->Vel.z = 0.0f;
