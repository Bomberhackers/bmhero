...
{
    func_80027464(1, &D_80113F7C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
{
    func_80027464(1, &D_80113F88, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_800C9EF0(void)
{
    ...
    sp24 = func_80027464(1, &D_80113FD0, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_800CAE40(void)
{
    ...
    if (func_8001B62C(gCurrentParsedObject, 0) == 30.0f)
    {
        sp50 = sp5C->unk3C;
        sp4C = sp5C->unk40;
        sp48 = func_80027464(1, &D_80113FF4, (sinf((f32)((f64)sp50 * D_80114FB0)) * 100.0f) + sp5C->Pos.x, (sinf((f32)((f64)sp4C * D_80114FB8)) * 10.0f) + sp5C->Pos.y, (cosf((f32)((f64)sp50 * D_80114FC0)) * 100.0f) + sp5C->Pos.z, sp5C->Rot.y);
        if (sp48 != -1)
        {
...
{
    func_80027464(1, &D_80114000, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_800CBB58(void)
{
    ...
    switch ((s32)gObjects[gCurrentParsedObject].unk3C)
    { /* irregular */
    case 0x0:
        sp34->Rot.x += 12.0f;
        break;
