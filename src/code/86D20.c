...
void func_80095A20(void)
{
    ...
    gObjects[gCurrentParsedObject].Vel.x = gObjects[gCurrentParsedObject].Vel.y = gObjects[gCurrentParsedObject].Vel.z = 0.0f;
...
void func_80097730(void)
{
    ...
    sp24 = func_80027464(1, &D_8011364C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkA6 = D_80165100->unkA;
    }
...
void func_80097A90(void)
{
    ...
    sp24 = func_80027464(1, &D_80113628, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkA6 = D_80165100->unkA;
    }
...
{
    func_80027464(1, &D_80113634, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_80098208(void)
{
    ...
    sp24 = func_80027464(1, &D_80113664, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkA6 = D_80165100->unkA;
    }
...
void func_8009868C(void)
{
    ...
    sp24 = func_80027464(1, &D_80113670, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkA6 = D_80165100->unkA;
...
void func_80098864(s32 arg0, s32 arg1, s32 arg2)
{
    ...
    if (spAC->unkE6[0] != -1)
    {
        ...
        guMtxXFMF(sp68, D_8011482C[arg1].x, D_8011482C[arg1].y, D_8011482C[arg1].z, &spAC->Pos.x, &spAC->Pos.y, &spAC->Pos.z);
        if (arg2 != 0)
        {
...
void func_80098AA4(void)
{
    ...
    if (func_8002A1FC(gCurrentParsedObject, 960.0f) != 0)
    {
        ...
        sp30 = func_800156C4(gPlayerObject->Pos.x - sp34->Pos.x, gPlayerObject->Pos.y - sp34->Pos.y);
...
void func_80099084(void)
{
    ...
    sp24 = func_80027464(5, &D_8011346C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_80099454(void)
{
    ...
    if ((spD4->unkA8 == 1) && (spD4->unkAA == 0) && (spD4->unkAC == 0) && (func_80014E80(0xA) == 0) && ((spD4->Pos.z + 120.0f) < gPlayerObject->Pos.z))
    {
        spD4->unkAC = 0x40;
        spD4->unkAA = 0x3C;
    }
...
void func_80099F80(void)
{
    ...
    if (spBC->unkA6 == 0)
    {
        if ((spB4 == 0) && ((spBC->Pos.z + 120.0f) < gPlayerObject->Pos.z) && (func_80014E80(0xA) == 0))
        {
...
void func_8009A390(void)
{
    ...
    sp24 = func_80027464(5, &D_801134A8, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        func_80098864(gObjects[sp24].unkE8[0], 0, 1);
        func_80098864(gObjects[sp24].unkE8[1], 1, 1);
...
void func_8009AA10(void)
{
    ...
    if (spBC->unkA6 == 0)
    {
        if ((spB4 == 0) && (func_8002A1FC(gCurrentParsedObject, 960.0f) != 0) && (func_80014E80(0xA) == 0))
        {
            func_8001C0EC(gCurrentParsedObject, 0, 0, 0xAB, &D_80116940);
            func_8001B754(gCurrentParsedObject, 0);
            spBC->unkA6 = 0x3C;
...
void func_8009AE7C(void)
{
    ...
    sp24 = func_80027464(3, &D_801134E4, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
{
    func_80027464(1, &D_80113508, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_8009B548(void)
{
    ...
    sp24 = func_80027464(1, &D_80113514, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_8009B600(void)
{
    ...
    sp34 = func_80027464(1, &D_80113520, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp34 != -1)
    {
...
{
    func_80027464(1, &D_8011352C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}

void func_8009B97C(void)
{
    func_80027464(1, &D_80113538, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_8009C598(void)
{
    ...
    sp24 = func_80027464(2, &D_8011358C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_8009CBE4(void)
{
    ...
    sp24 = func_80027464(1, &D_801135A4, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
...
void func_8009CC88(void)
{
    ...
    if (sp4C->unk132 == 1)
    {
        ...
        {
            func_80067748((f32)D_801148A4[sp38].unk0 + sp4C->Pos.x, sp4C->Pos.y - 60.0f, (f32)D_801148A4[sp38].unk2 + sp4C->Pos.z);
    ...
    if (sp4C->unkA6 != 0)
    {
        ...
        {
            sp3C = func_800293B8((s16)(D_80114874[sp4C->unkA6].unk0_2[sp38 - 2].unk0) + sp4C->Pos.x, sp4C->Pos.y - 60.0f,
                                 ((s16)D_80114874[sp4C->unkA6].unk0_0[sp38 - 2]) + sp4C->Pos.z,
                                 (f32)D_80114890[sp4C->unkA6].unk0, 0.0f,
                                 (f32)D_80114892[sp4C->unkA6].unk0,
                                 &sp48, &sp44, &sp40, 0x1E);
...
void func_8009D558(void)
{
    ...
    sp24 = func_80027464(1, &D_801135BC, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    func_8001ABF4(sp24, 0, 0, &D_80116AB8);
...
{
    func_80027464(1, &D_80113604, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
{
    func_80027464(1, &D_80113610, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_8009E67C(void)
{
    ...
    sp24 = func_80027464(1, &D_80113658, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_8009E7F0(void)
{
    ...
    sp28 = func_80027464(1, sp2C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp28 != -1)
    {
...
void func_8009ECE8(void)
{
    ...
    sp24 = func_80027464(1, &D_801136A0, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
void func_8009ED88(void)
{
    ...
    sp24 = func_80027464(1, &D_801136AC, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
...
{
    func_80027464(1, &D_801136B8, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
{
    func_80027464(1, &D_801136E8, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
}
...
void func_800A0418(void)
{
    ...
    sp24 = func_80027464(1, &D_8011343C, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp24 != -1)
    {
        gObjects[sp24].unkAE = D_80165100->unkE;
    }
...
void func_800A10C0(void)
{
    ...
    sp26 = func_80027464(4, &D_80113844, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp26 != -1)
    {
...
void func_800A1A0C(void)
{
    ...
    if (sp1C->unkA6 <= 0)
    {
        sp1C->unkA4 = sp1C->unkAA;
        sp1C->unk132 = 0;
    }
    if ((sp1C->unkAA == 8) && (func_8002A2EC(gCurrentParsedObject, 240.0f) != 0) && (func_8002A3A8(gCurrentParsedObject, 720.0f) != 0))
    {
        sp1C->unkA4 = 4;
        sp1C->unkB0 = 2;
        sp1C->unk132 = 0;
...
{
    if (gObjects[gCurrentParsedObject].unkA4 == 2)
    {
        func_800A1FBC();
    }
}
...
void func_800A2058(void)
{
    ...
    sp26 = func_80027464(4, &D_80113874, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp26 != -1)
    {
        gObjects[sp26].unkA4 = 1;
        gObjects[sp26].unkA8 = 1;
...
void func_800A2AA4(void)
{
    ...
    sp2E = func_80027464(1, &D_801138A4, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp2E != -1)
    {
...
void func_800A2BBC(void)
{
    ...
    sp1E = gObjects[gCurrentParsedObject].unkA4;
    if (sp1E == 1)
    {
        if (FALSE)
        {
...
void func_800A2C44(void)
{
    ...
    {
        sp4C->unk132 = 1;
        sp4C->unk3C = (f32)func_80014E80(0x168);
        sp4C->unk44 = 5.0f;
        sp4C->unk40 = 90.0f;
    }
    func_80029C40(gCurrentParsedObject);
    ...
    sp4C->Vel.y = (sp4C->Vel.y > 48.0f) ? 48.0f : (sp4C->Vel.y < -48.0F) ? -48.0f
                                                                         : sp4C->Vel.y;
...
void func_800A32E4(void)
{
    ...
    sp2E = func_80027464(1, &D_801138B0, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp2E != -1)
    {
...
void func_800A3BCC(void)
{
    ...
    sp2E = func_80027464(1, &D_801138BC, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp2E != -1)
    {
        gObjects[sp2E].unkA4 = 1;
        gObjects[sp2E].unk132 = 0;
...
void func_800A3D80(void)
{
    ...
    sp26 = gObjects[gCurrentParsedObject].unkA4;
    switch (sp26)
    {
    case 1:
        func_800A3E28();
...
void func_800A46E4(void)
{
    ...
    sp2E = func_80027464(1, &D_801138C8, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp2E != -1)
    {
        gObjects[sp2E].Scale.x = 1.5f;
        gObjects[sp2E].Scale.z = gObjects[sp2E].Scale.y = gObjects[sp2E].Scale.x;
...
void func_800A4C54(void)
{
    ...
    {
        func_80029824(gCurrentParsedObject, func_800297DC());
        if ((D_801651A0 & 0x80) && (((sp34->Pos.y < (sp34->unk54 - 1920.0f))) || ((sp34->unk54 + 1920.0f) < sp34->Pos.y)))
        {
            sp34->unkA4 = 6;
            sp34->unk132 = 0;
            return;
...
void func_800A5B74(void)
{
    ...
    sp26 = func_80027464(2, &D_801138F8, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp26 != -1)
    {
        gObjects[sp26].unkA4 = 1;
        gObjects[sp26].unk132 = 0;
...
void func_800A62A8(void)
{
    ...
    if (sp34->unk132 == 0)
    {
        ...
        sp34->unk44 = 8.0f;
        sp34->unk48 = 0.0f;
        sp34->unkAE = (s16)(s32)func_80015538(sp34->unk3C, (f32)(func_80014E80(-1) * 0x3C));
        sp34->unkAE = (s16)(s32)func_80015538((f32)sp34->unkAE, (f32)func_80014E80(-0x1E));
        sp34->unkA6 = func_80014E80(0x3C) + 0xB4;
    }
    if (func_80028FA0(gCurrentParsedObject) != 0)
    {
        func_80029B60(gCurrentParsedObject);
...
void func_800A6DE8(void)
{
    ...
    if (sp34->unk132 == 2)
    {
        sp34->unk3C = func_80015538(sp34->unk3C, (f32)func_80014E80(-0x28));
        sp34->unk44 = (f32)(func_80014E80(5) + 2);
...
void func_800A7894(void)
{
    ...
    sp26 = func_80027464(2, &D_80113910, (f32)D_80165100->unk2, (f32)D_80165100->unk4, (f32)D_80165100->unk6, (f32)D_80165100->unk8);
    if (sp26 != -1)
    {
        gObjects[sp26].unkA4 = 1;
...
void func_800A7C18(void)
{
    ...
    {
        sp2C->unk132 = 1;
        sp2C->unk44 = (f32)(func_80014E80(5) + 2);
        sp2C->unk48 = 0.0f;
    }
    func_8002A8B4(gCurrentParsedObject, 8.0f);
    if (func_80028FA0(gCurrentParsedObject) != 0)
...
void func_800A7DF0(void)
{
    ...
    sp3C->unk44 = (f32)(func_80014E80(5) + 2);
    sp3C->Scale.x = (f32)((f64)func_80014E80(-1) + D_80114A00);
    sp3C->Scale.y = (f32)((f64)func_80014E80(-1) + D_80114A08);
    sp3C->Scale.z = (f32)((f64)func_80014E80(-1) + D_80114A10);
